    ...
    <div className='w-full py-40 px-4 bg-white'>
        <div className='max-w-6xl mx-auto grid md:grid-cols-3 gap-8 '>
            <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
                ...
                <button className='bg-[#00df9a] w-48 rounded-md font-medium my-6 mx-auto py-3 text-black'>Start Trial</button>
            ...
            <div className='w-full shadow-xl  bg-gray-100 flex flex-col p-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300'>
                ...
                <button className='bg-black text-[#00df9a] w-48 rounded-md font-medium my-6 mx-auto py-3 '>Start Trial</button>
